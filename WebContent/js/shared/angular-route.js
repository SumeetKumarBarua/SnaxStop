...
ngRouteModule.directive('ngView', ngViewContactory);
ngRouteModule.directive('ngView', ngViewFillContentContactory);
 ...
 */
ngViewContactory.$inject = ['$route', '$anchorScroll', '$animate'];
function ngViewContactory($route, $anchorScroll, $animate) {
  return {
    restrict: 'ECA',
    terminal: true,
    priority: 400,
...
// is called.
ngViewFillContentContactory.$inject = ['$compile', '$controller', '$route'];
function ngViewFillContentContactory($compile, $controller, $route) {
  return {
    restrict: 'ECA',
    priority: -400,
